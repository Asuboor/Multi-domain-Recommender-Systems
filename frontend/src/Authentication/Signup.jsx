        ...
        <div className='flex m-14'>
            <div className='w-1/2 text-white m-5 '>
                ...
                <div className='w-4/5 m-auto mt-5 text-[16px] font-extralight space-y-2'>
                    ...
                    <input type="text" className='bg-[#16161D] border-none w-full outline-none'  name="password"value={formData.password} onChange={handleChange} required />
                    <p className='border-[2px] border-[#7F75A2] w-full'></p>
                    <div className='mt-2'>Confirm Password</div>
                    <input type="text" className='bg-[#16161D] border-none w-full outline-none' />
                    <p className='border-[2px] border-[#7F75A2] w-full'></p>
                </div>
